...
class Benefits {
   ...
   * @param {string} benefit.name - the beenfit item to de defined
   * @param {string} benefit.description - decription of benefit
   * @param {string} benefit.category - category of benefit
   * @param {JSON} benefit.urls - URLs to GOV.UK and application
   * @param {JSON} benefit.details - all details pertaining to benefit
