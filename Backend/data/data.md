...
- slug: universal-credit
  ...
  urls: # gov url in the details for frontend, leave apply URL leave there
  ...
  questions_to_ask: - { id: housing_status, question: "Do you pay rent or have a mortgage?", type: "boolean" } - { id: savings_check, question: "Do you have more than £16,000 in savings?", type: "boolean" }
...
- slug: pension-credit
  ...
  questions_to_ask: - { id: age_check, question: "Are you or your partner at State Pension age (66)?", type: "boolean" }
...
- slug: child-benefit
  ...
  questions_to_ask: - { id: child_responsibility, question: "Are you responsible for a child under 16 (or 20 in education)?", type: "boolean" }
...
- slug: carers-allowance
  ...
  questions_to_ask: - { id: caring_hours, question: "Do you provide care for at least 35 hours a week?", type: "boolean" }
...
- slug: free-school-meals
  ...
  questions_to_ask: - { id: schooling_child, question: "Do you have a child in a state-funded school?", type: "boolean" }
...
- slug: attendance-allowance
  ...
  questions_to_ask: - { id: daily_help_needs, question: "Do you need frequent help with personal care or supervision?", type: "boolean" }
...
- slug: pip
  ...
  questions_to_ask: - { id: mobility_issues, question: "Does your condition make it hard for you to move around or daily tasks?", type: "boolean" }
...
- slug: healthy-start
  ...
  questions_to_ask: - { id: income_check, question: "Is your monthly take-home pay £408 or less?", type: "boolean" }
...
- slug: budgeting-loan
  ...
  questions_to_ask: - { id: uc_check, question: "Are you currently claiming Universal Credit?", type: "boolean" }
...
- glossary_slug: department_for_communities
  ...
  related_benefits:
- glossary*slug: department_for_work_and_pensions*(DWP)
...
- glossary_slug: disability_benefit
  ...
  related_benefits:
- glossary*slug: disability_living_allowance*(DLA)
...
- glossary_slug: dwp
  ...
  definition: "The government department responsible for welfare and benefits in Great Britain."
  related_benefits:
- glossary*slug: employment_and_support_allowance*(ESA)
...
- glossary_slug: income_support
  ...
  related_benefits:
- glossary*slug: jobseeker's_allowance*(JSA)
...
- glossary_slug: social_services
  ...
  related_benefits:
- glossary*slug: state_earnings_related_pension_scheme*(SERPS)
